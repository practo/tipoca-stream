...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ConsumerGroups) DeepCopyInto(out *ConsumerGroups) {
	{
		in := &in
		*out = make(ConsumerGroups, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConsumerGroups.
func (in ConsumerGroups) DeepCopy() ConsumerGroups {
	if in == nil {
		return nil
	}
	out := new(ConsumerGroups)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *RedshiftSinkStatus) DeepCopyInto(out *RedshiftSinkStatus) {
	*out = *in
	...
	if in.SinkGroupStatus != nil {
		in, out := &in.SinkGroupStatus, &out.SinkGroupStatus
		*out = make(map[string]ConsumerGroups, len(*in))
		for key, val := range *in {
			var outVal map[string]ConsumerGroup
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
