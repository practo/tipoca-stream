...
func (in *RedshiftSinkStatus) DeepCopyInto(out *RedshiftSinkStatus) {
	*out = *in
	...
	if in.LoaderReloadingTopics != nil {
		in, out := &in.LoaderReloadingTopics, &out.LoaderReloadingTopics
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.LoaderTopicGroupCurrentOffset != nil {
		in, out := &in.LoaderTopicGroupCurrentOffset, &out.LoaderTopicGroupCurrentOffset
		*out = make(map[string]int64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.DeadConsumerGroups != nil {
		in, out := &in.DeadConsumerGroups, &out.DeadConsumerGroups
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
